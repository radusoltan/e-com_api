...
use App\Repository\ProductVariationAttributeValueRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ProductVariationAttributeValueRepository::class)]
#[ORM\UniqueConstraint(
    name: 'unique_variation_attribute',
    columns: ['variation_id', 'attribute_id']
)]
class ProductVariationAttributeValue
{
    ...
    #[ORM\ManyToOne(inversedBy: 'variationAttributeValues')]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    ...
    public function setVariation(?ProductVariation $variation): self
    {
